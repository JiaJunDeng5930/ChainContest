...
const actorContextSchema = z
  .object({
    ...
    source: z.enum(walletSourceValues as [string, ...string[]]).optional(),
...
const numericLikeSchema = z.union([
  ...
  z.bigint().refine((value) => value >= 0n),
  z.string().regex(/^\d+$/)
]);
...
export const buildTestValidators = (): ValidatorRegistrationOptions => ({
  registry: [
    {
    ...
    },
    {
      ...
      kind: 'atomic',
      rule: {
        description: 'Contest aggregation request',
    ...
    },
    {
      ...
      kind: 'atomic',
      rule: {
        description: 'Contest domain write',
    ...
    },
    {
      ...
      kind: 'atomic',
      rule: {
        description: 'Ingestion status request',
    ...
    },
    {
      ...
      kind: 'atomic',
      rule: {
        description: 'Ingestion event request',
